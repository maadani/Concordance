...
if object_id('sp_demo_source','P') is not null
...
if object_id('f_demo_datetoQ','FN') is not null
DROP FUNCTION f_demo_datetoQ
go
CREATE FUNCTION f_demo_datetoQ ( @dDate datetime )
RETURNS NVARCHAR(40)
AS
BEGIN
...
if object_id('demo_city','U') is not null
...
if object_id('demo_country','U') is not null
...
GovernmentForm nvarchar(45) NOT NULL,
HeadOfState nvarchar(60) default NULL,
Capital int NULL,
...
go
INSERT INTO demo_country VALUES ('DZA','Algeria','Africa','Northern Africa',2381741.00,1962,31471000,69.7,49982.00,46966.00,'Al-Jazair/Algérie','Republic','Abdelaziz Bouteflika',35,'DZ')
go
...
INSERT INTO demo_country VALUES ('ISR','Israel','Asia','Middle East',21056.00,1948,6217000,78.6,97477.00,98577.00,'Yisrael/Israil','Republic','Moshe Katzav',1450,'IL')
...
INSERT INTO demo_country VALUES ('KOR','South Korea','Asia','Eastern Asia',99434.00,1948,46844000,74.4,320749.00,442544.00,'Taehan Minguk (Namhan)','Republic','Kim Dae-jung',2331,'KR')
...
INSERT INTO demo_country VALUES ('CIV','Côte dIvoire','Africa','Western Africa',322463.00,1960,14786000,45.2,11345.00,10285.00,'Côte dIvoire','Republic','Laurent Gbagbo',2814,'CI')
...
INSERT INTO demo_country VALUES ('TWN','Taiwan','Asia','Eastern Asia',36188.00,1945,22256000,76.4,256254.00,263451.00,'Tai-wan','Republic','Chen Shui-bian',3263,'TW')
...
go
INSERT INTO demo_country VALUES ('ATA','Antarctica','Antarctica','Antarctica',13120000.00,NULL,0,NULL,0.00,NULL,'','Co-administrated','','','AQ')
go
INSERT INTO demo_country VALUES ('BVT','Bouvet Island','Antarctica','Antarctica',59.00,NULL,0,NULL,0.00,NULL,'Bouvetøya','Dependent Territory of Norway','Harald V','','BV')
go
INSERT INTO demo_country VALUES ('IOT','British Indian Ocean Territory','Africa','Eastern Africa',78.00,NULL,0,NULL,0.00,NULL,'British Indian Ocean Territory','Dependent Territory of the UK','Elisabeth II','','IO')
INSERT INTO demo_country VALUES ('SGS','South Georgia and the South Sandwich Islands','Antarctica','Antarctica',3903.00,NULL,0,NULL,0.00,NULL,'South Georgia and the South Sandwich Islands','Dependent Territory of the UK','Elisabeth II','','GS')
go
INSERT INTO demo_country VALUES ('HMD','Heard Island and McDonald Islands','Antarctica','Antarctica',359.00,NULL,0,NULL,0.00,NULL,'Heard and McDonald Islands','Territory of Australia','Elisabeth II','','HM')
INSERT INTO demo_country VALUES ('ATF','French Southern territories','Antarctica','Antarctica',7780.00,NULL,0,NULL,0.00,NULL,'Terres australes françaises','Nonmetropolitan Territory of France','Jacques Chirac','','TF')
INSERT INTO demo_country VALUES ('UMI','United States Minor Outlying Islands','Oceania','Micronesia/Caribbean',16.00,NULL,0,NULL,0.00,NULL,'United States Minor Outlying Islands','Dependent Territory of the US','George W. Bush','','UM')
go

if object_id('demo_atom','U') is not null
...
if object_id('demo_molecule','U') is not null
...
if object_id('demo_production','U') is not null
...
if object_id('demo_oem_cluster','U') is not null
...
if object_id('demo_platform','U') is not null
...
if object_id('demo_oem_platform','U') is not null
DROP TABLE demo_oem_platform
go
CREATE TABLE demo_oem_platform (
oem NVARCHAR(40) NOT NULL,
...
if object_id('demo_platform_tech','U') is not null
DROP TABLE demo_platform_tech
go
CREATE TABLE demo_platform_tech (
	platform NVARCHAR(40) NOT NULL,
	tech NVARCHAR(40) NOT NULL,
	year INT NULL,
)
go
...
if object_id('demo_tech','U') is not null
...
if object_id('demo_corporate','U') is not null
...
if object_id('sp_DBR_demo_countries','P') is not null
...
if object_id('sp_DBR_demo_country','P') is not null
DROP PROCEDURE sp_DBR_demo_country
go
CREATE PROCEDURE sp_DBR_demo_country( @inCode nvarchar(10) )
AS
BEGIN

	-- for storing @inCode country name
	DECLARE @vCountry_name NVARCHAR(20)
	...
	SELECT  c.Name+', ' +@vCountry_name, 
			c.Name+', '+@vCountry_name+'<br> Population: '+cast(c.Population as nvarchar),
			CASE 
...
if object_id('sp_DBR_demo_city','P') is not null
	...
	ELSE BEGIN
		...
		SELECT city.Name+', '+country.Name, 
			    '<b>'+city.Name+country.Name+'</b><br><br>', 
						'Population in '+city.Name+': '+convert(nvarchar(20),city.Population)+'<br>'+
...
*/
if object_id('sp_demo_autocomplete_cities','P') is not null
...
BEGIN
	...
	SELECT city.Name, country.Name 
	FROM demo_city city, demo_country country 
	WHERE city.CountryCode = country.Code and city.Name like '%'+@inParam+'%'
	ORDER BY city.name

END
go

if object_id('sp_DBR_demo_crosstab','P') is not null
...
if object_id('sp_DBR_demo_subtotals','P') is not null
...
if object_id('sp_DBR_demo_chart_examples','P') is not null
...
if object_id('sp_DBR_demo_chart_transpose','P') is not null
...
if object_id('sp_DBR_demo_gv_smartphone','P') is not null
...
AS
BEGIN
	DECLARE @vOS NVARCHAR(250)
	DECLARE @vUI NVARCHAR(250)
	DECLARE @vOEM NVARCHAR(250)
	DECLARE @vCluster NVARCHAR(250)
	DECLARE @vFont NVARCHAR(30)
	DECLARE @vCnt int
	...
	SELECT 'dbr.title', 'Smartphone vendors and technology '+CAST( @inYear AS NVARCHAR )
...
if object_id('sp_DBR_demo_pictures','P') is not null
...
if object_id('sp_DBR_demo_objects','P') is not null
...
if object_id('sp_DBR_demo_googlemaps_paris1','P') is not null
...
if object_id('sp_DBR_demo_googlemaps_paris','P') is not null
...
if object_id('sp_DBR_demo_gv_simple','P') is not null
...
if object_id('sp_DBR_demo_gv_options','P') is not null
...
if object_id('sp_DBR_demo_gv_formatting','P') is not null
...
if object_id('sp_DBR_demo_gv_edge','P') is not null
...
if object_id('sp_DBR_demo_gv_cluster','P') is not null
