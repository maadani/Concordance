...
INSERT INTO `mydbr_folders` VALUES (1,NULL,'#{MYDBR_AMAIN_HOME}',2,1,NULL),(2,1,'Admin reports',2,1,NULL),(3,2,'Drill reports',2,1,NULL),(4,1,'Internal Reports',2,1,NULL),(5,1,'7. Groups',2,1,NULL),(6,1,'8. Relations',2,1,NULL),(7,1,'9. Expressions',2,1,NULL),(8,1,'10. Stats',2,1,NULL),(9,1,'2. Meta Data',2,1,NULL),(10,1,'3. Find Sonnet',2,1,NULL);
...
INSERT INTO `mydbr_reports` VALUES (1,'Statistics summary','sp_DBR_StatisticsSummary',2,'',1,NULL,NULL,NULL,NULL,NULL),(2,'Statistics for a report','sp_DBR_StatisticsReport',3,'',1,NULL,NULL,NULL,NULL,NULL),(5,'1. Add New Group','sp_DBR_add_new_group',5,'',1,NULL,'Add Group',NULL,NULL,NULL),(7,'4. Show Words For Sonnet','sp_DBR_words_by_recipe',1,'',1,NULL,NULL,NULL,NULL,NULL),(9,'2. Add Word to Group','sp_DBR_add_word_to_group',5,'',1,NULL,'Add Word To Group',NULL,NULL,NULL),(10,'4. Group Words','sp_DBR_get_words_for_group_id',5,'',1,NULL,NULL,NULL,NULL,NULL),(12,'3. Group Word Index','sp_DBR_get_locations_for_group',5,'',1,NULL,NULL,NULL,NULL,NULL),(13,'4.1. Show Word Context','sp_DBR_context_for_word',4,'',1,NULL,NULL,NULL,NULL,NULL),(15,'6. Find Words By Location','sp_DBR_get_word_by_location',1,'',1,NULL,NULL,NULL,NULL,NULL),(16,'5. Complete Word Index','sp_DBR_get_complete_word_index',1,'',1,NULL,NULL,NULL,NULL,NULL),(18,'1. Add New Relation ','sp_DBR_add_new_relation',6,'',1,NULL,NULL,NULL,NULL,NULL),(19,'2. Add Words to Relation','sp_DBR_add_words_to_relation',6,'',1,NULL,NULL,NULL,NULL,NULL),(21,'1. Load File','sp_DBR_load_file',1,'',1,NULL,'Load File',NULL,NULL,NULL),(22,'4. Relation Words','sp_DBR_get_words_for_relation',6,'',1,NULL,NULL,NULL,NULL,NULL),(23,'9.1. Add Expression','sp_DBR_add_expression',7,'',1,NULL,NULL,NULL,NULL,NULL),(25,'1. Word Counts','sp_DBR_word_count_for_sonnet',8,'',1,NULL,NULL,NULL,NULL,NULL),(26,'10.1. Word Count per Section','sp_DBR_get_word_count_per_section_for_sonnet',4,'',1,NULL,NULL,NULL,NULL,NULL),(27,'10.2. Word Count per Line','sp_DBR_word_count_per_line_for_section',4,'',1,NULL,NULL,NULL,NULL,NULL),(28,'2. Char Counts','sp_DBR_char_count_for_sonnet',8,'',1,NULL,NULL,NULL,NULL,NULL),(29,'10.3. Char Count per Section','sp_DBR_get_char_count_per_section_for_sonnet',4,'',1,NULL,NULL,NULL,NULL,NULL),(30,'10.4. Char Count per Line','sp_DBR_char_count_per_line_for_section',4,'',1,NULL,NULL,NULL,NULL,NULL),(31,'10.5. Char Count per Word','sp_DBR_char_count_per_word_for_line',4,'',1,NULL,NULL,NULL,NULL,NULL),(32,'2.1. Set Author','sp_DBR_set_author',9,'',1,NULL,NULL,NULL,NULL,NULL),(33,'2.2. Set Name','sp_DBR_set_name',9,'',1,NULL,NULL,NULL,NULL,NULL),(34,'2.3. Set Sequence','sp_DBR_set_sequence',9,'',1,NULL,NULL,NULL,NULL,NULL),(35,'2.4. Set Rhyme Scheme','sp_DBR_set_rhyme_scheme_for_sonnet',9,'',1,NULL,NULL,NULL,NULL,NULL),(36,'3. Word Frequency','sp_DBR_word_frequency',8,'',1,NULL,NULL,NULL,NULL,NULL),(38,'3.2. By Author','sp_DBR_find_sonnet_by_author',10,'',1,NULL,NULL,NULL,NULL,NULL),(39,'3.3. By Sequence','sp_DBR_get_sonnet_by_sequence',10,'',1,NULL,NULL,NULL,NULL,NULL),(40,'3.1. By Name','sp_DBR_get_sonnet_by_id',10,'',1,NULL,NULL,NULL,NULL,NULL),(41,'3.5. By Word','sp_DBR_get_sonnet_by_word',10,'',1,NULL,NULL,NULL,NULL,NULL),(42,'3.4. By Rhyme Scheme','sp_DBR_get_sonnet_by_rhyme_scheme',10,'',1,NULL,NULL,NULL,NULL,NULL),(43,'9.2. Find Expression in Sonnet','sp_DBR_find_expression',7,'',1,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `mydbr_update` VALUES ('4.6.0',1465719889,'http://www.mydbr.com/fileserve.php?get=mydbr_app.zip','http://www.mydbr.com/getpost.php?id=6875',1465547089,'120a2b399b789fdfff24cfe702e827146be5e6a2');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_DBR_add_exr` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_add_exr`(inTextFromUser varchar(250))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_DBR_find_expression` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_find_expression`(inExprId int, inSonnetId int)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_DBR_find_sonnet_by_author` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_find_sonnet_by_author`(inAuthorName varchar (50))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_DBR_get_sonnet_by_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_get_sonnet_by_id`(inSonnetId int)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_DBR_get_sonnet_by_rhyme_scheme` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_get_sonnet_by_rhyme_scheme`(inRhymeScheme varchar(32))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_DBR_get_sonnet_by_sequence` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_get_sonnet_by_sequence`(inSeqId int)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_DBR_get_sonnet_by_word` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_get_sonnet_by_word`(inWordId int)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_DBR_set_rhyme_scheme_for_sonnet` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_set_rhyme_scheme_for_sonnet`(IN inSonnetId int, IN inRhymeScheme varchar(32))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_DBR_word_frequency` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_word_frequency`(inWordId int)
BEGIN
...
-- Dump completed on 2016-06-10 12:06:42
