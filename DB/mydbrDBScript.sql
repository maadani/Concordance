...
INSERT INTO `mydbr_param_queries` VALUES ('Actual Groups','concordancedb.get_group_list',0,'{}'),('actual relations','concordancedb.get_relation_list',0,'{}'),('Empty','Select \' \'',3,'{}'),('groups','concordancedb.get_extended_group_list',0,'{\"find\":true}'),('MonthAgo','select  cast(date_add(now(), interval -1 month) as date)\r\n',3,NULL),('Now','select cast(now() as date)',3,NULL),('Rec','concordancedb.get_sonnet_names',0,'{}'),('Relations','concordancedb.get_extended_relation_list',0,'{}'),('Sections','concordancedb.get_sections\r\n',0,'{}'),('Sequences','concordancedb.get_seq_names',0,'{}'),('Steps_5-10-20-100','select 5, 5\r\nunion\r\nselect 10, 10\r\nunion\r\nselect 20, 20\r\nunion\r\nselect 50, 50\r\nunion\r\nselect 100, 100\r\n\r\n',0,NULL),('words','concordancedb.get_word_list',0,'{\"find\":true}'),('Yes No','select 1, \'Yes\' \r\nunion \r\nselect 0, \'No\'',1,NULL);
...
INSERT INTO `mydbr_reports` VALUES (1,'Statistics summary','sp_DBR_StatisticsSummary',2,'',1,NULL,NULL,NULL,NULL,NULL),(2,'Statistics for a report','sp_DBR_StatisticsReport',3,'',1,NULL,NULL,NULL,NULL,NULL),(5,'1. Add New Group','sp_DBR_add_new_group',5,'',1,NULL,'Add Group',NULL,NULL,NULL),(7,'4. Show Words For Sonnet','sp_DBR_words_by_recipe',1,'',1,NULL,NULL,NULL,NULL,NULL),(9,'2. Add Word to Group','sp_DBR_add_word_to_group',5,'',1,NULL,'Add Word To Group',NULL,NULL,NULL),(10,'4. Group Words','sp_DBR_get_words_for_group_id',5,'',1,NULL,NULL,NULL,NULL,NULL),(12,'3. Group Word Index','sp_DBR_get_locations_for_group',5,'',1,NULL,NULL,NULL,NULL,NULL),(13,'4.1. Show Word Context','sp_DBR_context_for_word',4,'',1,NULL,NULL,NULL,NULL,NULL),(14,'3. Find Sonnet','sp_DBR_find_recipe',1,'',1,NULL,'Find Recipe',NULL,NULL,NULL),(15,'6. Find Words By Location','sp_DBR_get_word_by_location',1,'',1,NULL,NULL,NULL,NULL,NULL),(16,'5. Complete Word Index','sp_DBR_get_complete_word_index',1,'',1,NULL,NULL,NULL,NULL,NULL),(18,'1. Add New Relation ','sp_DBR_add_new_relation',6,'',1,NULL,NULL,NULL,NULL,NULL),(19,'2. Add Words to Relation','sp_DBR_add_words_to_relation',6,'',1,NULL,NULL,NULL,NULL,NULL),(21,'1. Load File','sp_DBR_load_file',1,'',1,NULL,'Load File',NULL,NULL,NULL);
...
INSERT INTO `mydbr_update` VALUES ('4.5.1',1447673926,'http://www.mydbr.com/fileserve.php?get=mydbr_app.zip','http://www.mydbr.com/getpost.php?id=6432',1447501126,'e1c7302f01bc45ab0943dbbbcb05bca6721e539f');
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_find_recipe`(inName varchar(45), inAuther varchar(45), inSequenceId int, inContainsText varchar(200))
BEGIN
...
-- Dump completed on 2015-11-17 23:21:13
