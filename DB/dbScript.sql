...
/*!50003 DROP PROCEDURE IF EXISTS `get_locations_for_group` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_locations_for_group`(inGroupId int)
BEGIN
...
-- Dump completed on 2015-08-30  2:52:11
...
INSERT INTO `mydbr_folders` VALUES (1,NULL,'#{MYDBR_AMAIN_HOME}',2,1,NULL),(2,1,'Admin reports',2,1,NULL),(3,2,'Drill reports',2,1,NULL),(4,1,'Internal Reports',2,1,NULL);
...
INSERT INTO `mydbr_update` VALUES ('4.5.1',1441060212,'http://www.mydbr.com/fileserve.php?get=mydbr_app.zip','http://www.mydbr.com/getpost.php?id=6432',1440887412,'2d828302a96d3e309fdc168566a848be07419dfe');
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_dummy_rpt`(in_word_id int)
BEGIN
...
-- Dump completed on 2015-08-30  2:52:12
