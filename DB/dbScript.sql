...
INSERT INTO `words_in_recipes` VALUES (1,1,1,1,1),(2,1,2,2,1),(3,1,3,3,1),(4,1,4,4,1);
...
-- Dump completed on 2015-08-21 18:22:47
...
INSERT INTO `mydbr_update` VALUES ('4.5.1',1440335705,'http://www.mydbr.com/fileserve.php?get=mydbr_app.zip','http://www.mydbr.com/getpost.php?id=6432',1440162905,'c158380462a461789d85312e3b4570073201362b');
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DBR_dummy_rpt`()
BEGIN
...
-- Dump completed on 2015-08-21 18:22:48
