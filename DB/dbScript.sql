...
BEGIN
select 'Ginger' as 'word', 'Adrak' as 'recipe_name', '10' as 'line_index'
union
select 'Ginger' as 'word', 'Adrak' as 'recipe_name', '18' as 'line_index'
union
select 'Ginger' as 'word', 'Adrak' as 'recipe_name', '20' as 'line_index';
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2015-08-26 22:46:58
...
INSERT INTO `mydbr_folders` VALUES (1,NULL,'#{MYDBR_AMAIN_HOME}',2,1,NULL),(2,1,'Admin reports',2,1,NULL),(3,2,'Drill reports',2,1,NULL);
...
INSERT INTO `mydbr_update` VALUES ('4.5.1',1440786007,'http://www.mydbr.com/fileserve.php?get=mydbr_app.zip','http://www.mydbr.com/getpost.php?id=6432',1440613207,'34b6e84f5da7f7a242a8c49c81b173501dd379d0');
...
-- Dump completed on 2015-08-26 22:46:59
